...
e2sm_ccc_ctrl_hdr_frmt_1_t fill_rnd_ccc_ctrl_hdr_frmt()
{
  ...
  assert(dst.ric_style_type != 0 && "Invalid value");
...
e2sm_ccc_ctrl_msg_frmt_1_t fill_rnd_ctrl_msg_frmt_1(void)
{
  ...
  dst.sz_ctrl_msg_ran_conf = (rand() % 2) + 1;
...
static
ctrl_out_cell_t fill_rnd_ctrl_out_cell()
{
...
e2sm_ccc_ctrl_out_frmt_2_t fill_rnd_ctrl_out_frmt_2(void)
{
  ...
  for (size_t i = 0; i < dst.sz_ctrl_out_cell; i++) {
    dst.ctrl_out_cell[i] = fill_rnd_ctrl_out_cell();
  }
