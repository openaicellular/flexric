...
static struct test_t tests[] =
  ...
  ,\"ul_bitrate\":0,\"dl_tx\":0,\"ul_tx\":0,\"dl_retx\":0,\"ul_retx\":0,\"dl_sched_users_min\":0}}}", 
      { .cells_stats = {
        ...
        .ue_stats = {
          { .dl_bitrate = 0, .ul_bitrate = 0, .dl_tx = 0, .ul_tx = 0, .dl_mcs = 0, .ul_mcs = 0, .phr = 0, .cqi = 0},
          { .dl_bitrate = 0, .ul_bitrate = 0, .dl_tx = 0, .ul_tx = 0, .dl_mcs = 0, .ul_mcs = 0, .phr = 0, .cqi = 0},
          { .dl_bitrate = 0, .ul_bitrate = 0, .dl_tx = 0, .ul_tx = 0, .dl_mcs = 0, .ul_mcs = 0, .phr = 0, .cqi = 0},
          { .dl_bitrate = 0, .ul_bitrate = 0, .dl_tx = 0, .ul_tx = 0, .dl_mcs = 0, .ul_mcs = 0, .phr = 0, .cqi = 0},
          { .dl_bitrate = 0, .ul_bitrate = 0, .dl_tx = 0, .ul_tx = 0, .dl_mcs = 0, .ul_mcs = 0, .phr = 0, .cqi = 0},
    ...
    { "{\"message\":\"ue_get\",\"ue_list\":[{\"ran_ue_id\":2,\"amf_ue_id\":2,\"rnti\":17922,\"cells\":[{\"cell_id\":1,\"cqi\":12,\"ul_phr\":38}]}],\"message_id\":\"1\",\"time\":1807.759}\"}",
      {
        ...
        .ue_stats = {
          { .rnti = 17922, .dl_bitrate = 0, .ul_bitrate = 0, .dl_tx = 0, .ul_tx = 0, .dl_mcs = 0, .ul_mcs = 0, .phr = 38, .cqi = 12},
          { .rnti = 0, .dl_bitrate = 0, .ul_bitrate = 0, .dl_tx = 0, .ul_tx = 0, .dl_mcs = 0, .ul_mcs = 0, .phr = 0, .cqi = 0},
          { .rnti = 0, .dl_bitrate = 0, .ul_bitrate = 0, .dl_tx = 0, .ul_tx = 0, .dl_mcs = 0, .ul_mcs = 0, .phr = 0, .cqi = 0},
          { .rnti = 0, .dl_bitrate = 0, .ul_bitrate = 0, .dl_tx = 0, .ul_tx = 0, .dl_mcs = 0, .ul_mcs = 0, .phr = 0, .cqi = 0},
          { .rnti = 0, .dl_bitrate = 0, .ul_bitrate = 0, .dl_tx = 0, .ul_tx = 0, .dl_mcs = 0, .ul_mcs = 0, .phr = 0, .cqi = 0},
          { .rnti = 0, .dl_bitrate = 0, .ul_bitrate = 0, .dl_tx = 0, .ul_tx = 0, .dl_mcs = 0, .ul_mcs = 0, .phr = 0, .cqi = 0},
