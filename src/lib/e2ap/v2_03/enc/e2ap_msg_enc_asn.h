...
struct E2AP_PDU* e2ap_enc_removal_request_asn_pdu(const e2_removal_request_t*);

// E2 <-> RIC
byte_array_t e2ap_enc_removal_response_asn(const e2_removal_response_t*); 
byte_array_t e2ap_enc_removal_response_asn_msg(const e2ap_msg_t* msg);
struct E2AP_PDU* e2ap_enc_removal_response_asn_pdu(const e2_removal_response_t*);
