...
/* Implementation */
extern asn_per_constraints_t asn_PER_type_ProcedureCode_constr_1_e2ap_v3_01;
extern asn_TYPE_descriptor_t asn_DEF_ProcedureCode_e2ap_v3_01;
asn_struct_free_f ProcedureCode_free;
asn_struct_print_f ProcedureCode_print;
asn_constr_check_f ProcedureCode_constraint_e2ap_v3_01;
...
#define ProcedureCode_id_E42setup	((ProcedureCode_t)17)
#define ProcedureCode_id_E42RICsubscription	((ProcedureCode_t)18)
#define ProcedureCode_id_E42RICsubscriptionDelete	((ProcedureCode_t)19)
#define ProcedureCode_id_E42RICcontrol	((ProcedureCode_t)20)
#define ProcedureCode_id_E42updateE2node	((ProcedureCode_t)21)
