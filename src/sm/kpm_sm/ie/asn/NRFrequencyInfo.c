 ...
 * 	found in "../src/sm/kpm_sm/ie/e2sm_kpm_v3_00_modified.asn1"
 * 	`asn1c -gen-APER -no-gen-OER -fcompound-names -no-gen-example -findirect-choice -fno-include-deps -D ../src/sm/kpm_sm/ie/asn`
 */
