...
{ 
  ...
  subscribe_timer_t timer = { .type = KPM_V2_03_V3_00_SUB_DATA_ENUM ,
...
sm_ind_data_t on_indication_kpm_sm_ag(sm_agent_t const* sm_agent, void* act_def_v)
{
 ...
 // sm_ag_if_rd_ind_t ind = {.type = KPM_STATS_V2_03_V3_00};
...
sm_agent_t *make_kpm_sm_agent(sm_io_ag_ran_t io)
{
  ...
  *(uint16_t*)(&sm->base.ran_func_id) = SM_KPM_ID; 
  ...
  // Read
  sm->base.io.read_ind = io.read_ind_tbl[KPM_STATS_V2_03_V3_00];
  sm->base.io.read_setup = io.read_setup_tbl[KPM_V2_03_V3_00_AGENT_IF_E2_SETUP_ANS_V0];
