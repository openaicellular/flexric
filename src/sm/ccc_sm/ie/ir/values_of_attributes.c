...
void free_values_of_attributes(values_of_attributes_t* src)
{
  ...
  if (src->values_of_attributes_type == VALUES_OF_ATTRIBUTES_O_GNBCUCPFunction_NODE_LEVEL)
    free_e2sm_ccc_o_gnb_cu_cp_function(&src->e2sm_ccc_o_gnb_cu_cp_function);

  if (src->values_of_attributes_type == VALUES_OF_ATTRIBUTES_O_GNBCUUPFunction_NODE_LEVEL)
    free_e2sm_ccc_o_gnb_cu_up_function(&src->e2sm_ccc_o_gnb_cu_up_function);

  if (src->values_of_attributes_type == VALUES_OF_ATTRIBUTES_O_GNBDUFunction_NODE_LEVEL)
    free_e2sm_ccc_o_gnb_du_function(&src->e2sm_ccc_o_gnb_du_function);

  if (src->values_of_attributes_type == VALUES_OF_ATTRIBUTES_O_RRMPolicyRatio_NODE_LEVEL)
...
bool eq_values_of_attributes(values_of_attributes_t const* m0, values_of_attributes_t const* m1)
{
  ...
  if(m0->values_of_attributes_type == VALUES_OF_ATTRIBUTES_O_GNBCUCPFunction_NODE_LEVEL)
    if (!eq_e2sm_ccc_o_gnb_cu_cp_function(&m0->e2sm_ccc_o_gnb_cu_cp_function, &m1->e2sm_ccc_o_gnb_cu_cp_function))
      return false;

  if(m0->values_of_attributes_type == VALUES_OF_ATTRIBUTES_O_GNBCUUPFunction_NODE_LEVEL)
    if (!eq_e2sm_ccc_o_gnb_cu_up_function(&m0->e2sm_ccc_o_gnb_cu_up_function, &m1->e2sm_ccc_o_gnb_cu_up_function))
      return false;

  if(m0->values_of_attributes_type == VALUES_OF_ATTRIBUTES_O_GNBDUFunction_NODE_LEVEL)
    if (!eq_e2sm_ccc_o_gnb_du_function(&m0->e2sm_ccc_o_gnb_du_function, &m1->e2sm_ccc_o_gnb_du_function))
      return false;

  if(m0->values_of_attributes_type == VALUES_OF_ATTRIBUTES_O_RRMPolicyRatio_NODE_LEVEL)
